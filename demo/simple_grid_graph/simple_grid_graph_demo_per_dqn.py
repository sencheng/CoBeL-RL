...
from cobel.agents.keras_rl.dqn import PERDQNAgentBaseline
...
def reward_callback(values: dict):
    '''
...
def single_run(visual_output: bool = True):
    ...
    if visual_output:
        main_window = qg.GraphicsLayoutWidget(title='Demo: DQN Agent using Prioritized Experience Replay')
        main_window.show()
