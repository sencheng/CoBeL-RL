...
class RewardMonitor(AbstractMonitor):
    ...
    def __init__(self, trials: int, gui_parent: pg.GraphicsLayoutWidget, visual_output: bool, reward_range: tuple | list = (0, 1)):
        '''
        ...
        None
        '''
        super().__init__(gui_parent, visual_output)
    ...
    def clear_plots(self):
        '''
        This function clears the plots generated by the reward monitor.
    ...
    def get_trace(self) -> np.ndarray:
        ...
        Returns
        ----------
        reward_trace :                      The reward trace.
        '''       
        return self.reward_trace
            
            
class ResponseMonitor(AbstractMonitor):
    ...
    def clear_plots(self):
        '''
        This function clears the plots generated by the response monitor.
    ...
    def get_trace(self) -> np.ndarray:
        ...
        Returns
        ----------
        response_trace :                    The response trace.
        '''       
        return self.responses
            

class EscapeLatencyMonitor(AbstractMonitor):
    ...
    def clear_plots(self):
        '''
        This function clears the plots generated by the escape latency monitor.
...
class TrajectoryMonitor(AbstractMonitor):
    ...
    def clear_plots(self):
        '''
        This function clears the plots generated by the trajectory monitor.
    ...
    def get_trace(self) -> list:
        ...
        Returns
        ----------
        trajectory_trace :                  The trajectory trace.
        '''       
        return self.trajectory_trace

            
class RepresentationMonitor(AbstractMonitor):
    
    def __init__(self, observations: np.ndarray | list | dict, dimensions: tuple, model: None | AbstractNetwork = None,
                 layer: int | str = -2, units: None | np.ndarray = None, update_interval: int = 1,
                 gui_parent: None | pg.GraphicsLayoutWidget = None, visual_output: bool = False):
        '''
        ...
        self.model = model
        self.layer = layer
        self.units = np.zeros(1).astype(int) if units is None else units
        self.last_update = 0
    ...
    def clear_plots(self):
        '''
        This function clears the plots generated by the representation monitor.
    ...
    def get_trace(self) -> np.ndarray:
        '''
        This function returns the activity trace.
        ...
        Returns
        ----------
        activity_trace :                    The activity trace in form of (trial, unit, observation).
        '''       
...
class UnityPerformanceMonitor:
    ...
    def __init__(self, gui_parent: pg.GraphicsLayoutWidget, visual_output: bool, reward_plot_viewbox: tuple = (-100, 10, 50),
                 steps_plot_viewbox: tuple = (0, 1000, 50)):
        '''
