...
class ReplayMonitor(AbstractMonitor):
    ...
    def clear_plots(self):
        '''
        This function clears the plots generated by the replay monitor.
    ...
    def get_trace(self) -> dict:
        '''
        This function returns the replay traces.
        ...
        Returns
        ----------
        replay_traces :                     The reward traces.
        '''       
        return self.replay_traces


class OptimalityMonitor(AbstractMonitor):
    ...
    def clear_plots(self):
        '''
        This function clears the plots generated by the optimality monitor.
    ...
    def compute_action_probs_single(self, q_values: np.ndarray, beta: float = 0, action_mask: None | np.ndarray = None) -> np.ndarray:
        '''
    ...
    def compute_action_probs(self, Q: np.ndarray, beta: float = 0., action_mask: None | np.ndarray = None) -> np.ndarray:
        '''
    ...
    def get_trace(self) -> np.ndarray:
        '''
        This function returns the optimality trace.
