...
if __name__ == '__main__':
    ...
    np.save(path + 'demo/offline_demo/worldInfo/safeZonePolygon.npy', modules['world'].safe_zone_polygon)
    np.save(path + 'demo/offline_demo/worldInfo/safeZoneVertices.npy', modules['world'].safe_zone_vertices)
    np.save(path + 'demo/offline_demo/worldInfo/safeZoneSegments.npy', modules['world'].safe_zone_segments)
