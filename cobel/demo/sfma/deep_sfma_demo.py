...
def build_model(input_shape: tuple, number_of_actions: int) -> Sequential:
    '''
...
def single_run():
    ...
    # initialize RL agent
    rl_agent = DeepSFMAAgent(interface_OAI=modules['rl_interface'], epsilon=0.1, beta=5, gamma=0.9,
